...
{
    public abstract class EfCoreDocumentTypeRepository : EfCoreRepository<FiratManagementSystemApiDbContext, DocumentType , Guid>, IDocumentTypeRepository
    {
        public EfCoreDocumentTypeRepository(IDbContextProvider<FiratManagementSystemApiDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
...
,
            ...
            query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? DocumentTypeConsts.GetDefaultSorting(false) : sorting);
...
,definition
        ...
        protected virtual IQueryable<DocumentType> ApplyFilter(
