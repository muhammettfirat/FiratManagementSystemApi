...
public class FiratManagementSystemApiHostMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public FiratManagementSystemApiHostMenuContributor(IConfiguration configuration)
    {
