...
public class FiratManagementSystemApiWebHostMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public FiratManagementSystemApiWebHostMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<FiratManagementSystemApiResource>();
